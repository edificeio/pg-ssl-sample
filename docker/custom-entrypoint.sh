...
pg_setup_hba_conf() {
	...
	: "${POSTGRES_HOST_AUTH_METHOD:=$auth}"
	{
		...
		echo "hostssl    all             all             127.0.0.1/32            trust"
		echo "hostssl    all             all             ::1/128                 trust"
		echo "hostssl    all             all             0.0.0.0/0                 trust"
		echo "hostssl    pgssl             all             0.0.0.0/0                 trust"
		echo "hostssl    replication     all             127.0.0.1/32            trust"
		echo "hostssl    replication     all             ::1/128                 trust"
	} > "$PGDATA/pg_hba.conf"
		{
  		echo
  		echo "ssl = on"
  		echo "ssl_cert_file = '/var/lib/postgresql/postgresdb.crt'"
  		echo "ssl_key_file = '/var/lib/postgresql/postgresdb.key'"
